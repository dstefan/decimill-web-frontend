...
<div id="content">
    ...
    <div class="content-right">
        ...
        <div class="content-block">
            ...
            <div class="content-block-header">
                ...
                <div style="float: right;">
                    <a id="showCompiledButton"
                       href="/scenario/<?= $scenario->getStudyId() ?>/<?= $scenario->getId() ?>"
                ...
                <span class="model-title">
                    ...
                    <span id="namespace"><?= $scenario->getNamespace() ?></span>: <span id="title"><?= $scenario->getTitle() ?></span>
                </span>
            ...
            <div id="titleEditForm"
                ...
                <input type="hidden" class="titleFormItem" name="id" value="<?= $scenario->getId() ?>" />
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="text" class="titleFormItem" name="title"
                                   style="width: 300px; border: solid 1px #a0a1a2;" value="<?= $scenario->getTitle() ?>" /></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="titleFormItem" name="namespace"
                                   style="width: 100px; border: solid 1px #a0a1a2;" value="<?= $scenario->getNamespace() ?>" /></td>
                    </tr>
                </table>
            ...
            <input type="hidden" class="compileForm" name="id" value="<?= $scenario->getId() ?>" />

            <!-- EDITOR TEXTAREA -->
            <textarea id="editor" class="compileForm" name="text"
                      style="box-sizing: border-box; width: 100%; height: 100%; padding: 10px;"><?= $scenario->getText() ?></textarea>
    ...
    <script type="text/javascript">
        ...
        function compile() {
            ...
            ScenarioManager.compile_scenario({
                post: data,
        ...
        function saveTitle() {
            ...
            ScenarioManager.update_scenario_title({
                post: data,
                success: function (res) {
                    ...
                    hideTitleEditForm();
                    setMenuItemTitle('scenario', id, title, namespace);
                }
            });
        }
