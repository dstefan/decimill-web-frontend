...
<div id="content" style="padding-top: 20px;">
    ...
    <div class="content-right">
        ...
        <div style="padding: 5px 15px 15px;">
            ...
            <div style="font-size: 25px; font-family: 'Roboto Condensed'; font-weight: 200;">
                My case studies
            </div>

            <div style="border-top: solid 1px #ccc; margin-top: 10px;"></div>
                ...
                <? foreach ($studies AS $study): ?>
                    ...
                    <div class="study-block">
                        ...
                        <div style="font-size: 16px; margin-bottom: 10px; font-weight: bold;">
                            <a href="/study/<?= $study->getId() ?>">
                                <?= $study->getTitle() ?>
                            </a>
                        </div>

                        <div style="color: #333; font-size: 14px; line-height: 1.4em;">
