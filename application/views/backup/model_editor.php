...
<div class="header">
    ...
    <div style="float: right; margin: 8px 16px 0 0;">
        ...
        <form id="deleteForm" action="/contextmanager/delete_model" method="post" style="float: left;">
...
<div class="main">
    ...
    <div class="rightColumn">
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $('#saveButton').click(function() {
                    ...
                    ContextManager.update_model_text({
                        post: {
                            id: id,
                            text: text
                        },
                        success: function(res) {
                            if (res.isError) {
                                ...
                                window.location = '/model/' + res.body.id;
                            }
                        }
                    });
                });
        ...
        <div class="editorWrapper">
            <textarea id="editor"><?= $model->getText() ?></textarea>
        </div>
